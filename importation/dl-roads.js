...
cantons.features.forEach(canton => {
  ...
  if (fs.existsSync('buildings/roads/overpass/' + props.Nom_abbr + '.gz') && fs.statSync('buildings/roads/overpass/' + props.Nom_abbr + '.gz').size >= 500) {
  ...
  if (props.Nom_abbr === 'FR') {
    coordinates = canton.geometry.coordinates[3][0];
  }
...
<osm-script output="json">
  ...
  cm += ' > buildings/roads/overpass/' + props.Nom_abbr + '.json.gz';
  console.log(cm);
